  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <Image src={card.image} alt="image" width={320} height={370} />
      </motion.div>
      <motion.button
        aria-hidden
        tabIndex={-1}
      ...
      <motion.div
        ...
        <motion.div
          ...
          <motion.div
            ...
            <Image src={card.logo} width={40} height={40} alt="play" />
          </motion.div>
    ...
    <motion.div
      ...
      <div className="card-inner">
        <motion.div
          ...
          <Image src={activeCard.image} alt="image" width={360} height={430} />
        </motion.div>
        <motion.button
        ...
        <motion.div
          ...
          <motion.div
            ...
            <motion.div
              ...
              className="rounded-lg">
              <Image src={activeCard.logo} width={40} height={40} alt="play" />
            </motion.div>
            <div className="desc-wrapper">
              <motion.span
